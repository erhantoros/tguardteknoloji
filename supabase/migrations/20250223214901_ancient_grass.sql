/*
  ...
  2. Fields Added/Modified
    - logo_url: For storing the logo image URL
    - company_name: Company name with default value
    - primary_color: Brand color with default value
